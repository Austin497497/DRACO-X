...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'bonusoffer8@gmail.com', // Your Mega A/c Email Here
            password: 'bonus8' // Your Mega A/c Password Here
        }).ready;
...
router.get('/', async (req, res) => {
    ...
    async function DRACO_PAIR_CODE() {
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'DRACO-XMD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of 𝐃𝐑𝐀𝐂𝐎-𝐗𝐌𝐃
...
⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Draco Vert GitHub Repo](https://github.com/Austin497497/DRACO-XMD)  

🚀 _Thanks for choosing 𝐃𝐑𝐀𝐂𝐎-𝐗𝐌𝐃 — Let the automation begin!_ ✨`;
